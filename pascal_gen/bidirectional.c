...
main(int argc, char *argv[])
{
    ...
    printf("type\n");
	printf("\tbracket_type = (\n");
    printf("\t\tBIDI_BRACKET_NONE,\n");
	printf("\t\tBIDI_BRACKET_OPEN,\n");
	printf("\t\tBIDI_BRACKET_CLOSE\n");
    printf("\t);\n\n");

    printf("\tPbracket=^bracket;\n");
    printf("\tbracket=record\n");
    printf("\t_type:bracket_type;\n");
    printf("\t_class:uint_least8_t;\n");
    printf("\tend;\n\n");
    printf("const\n\n");
             	
	printf("bidi_bracket:array[0..%d] of bracket = (\n",blen-1);  
	for (i = 0; i < blen; i++) {
		printf("\t(\n\t\t_type: %s;\n\t\t_class: "
		       "%" PRIuLEAST8 "\n\t",
